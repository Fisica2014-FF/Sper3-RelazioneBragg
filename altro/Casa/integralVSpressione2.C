...
void integralVSpressione2() {
		TString dir =gSystem->UnixPathName(__FILE__);
		dir.ReplaceAll("integralVSpressione2.C","");

		TCanvas* c2 = new TCanvas("c2", "Picchi integral 2",200,10,700,500);
		...
		ifstream inputf((dir + "picchi_integral2").Data());
		std::clog << (dir + "picchi_integral2").Data() << endl;
