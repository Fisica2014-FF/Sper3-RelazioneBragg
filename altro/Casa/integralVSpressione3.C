...
void integralVSpressione3() {
		TString dir =gSystem->UnixPathName(__FILE__);
		dir.ReplaceAll("integralVSpressione3.C","");

		TCanvas* c3 = new TCanvas("c3", "Picchi integral 3",200,10,700,500);
		...
		ifstream inputf((dir + "picchi_integral3").Data());
		std::clog << (dir + "picchi_integral3").Data() << endl;
